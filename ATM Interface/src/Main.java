...
class Main {
	...
	public static void main(String[] args)   //Main Method. The execution starts from this method
	{
		...
		String AcName = "Elone Musk";    //Declaring the account details
		String branchname = "Edlabad (muktainager)";
		String branchaddress = "Chotalia Hotel(c114), babu kalam, nearby baba chouk (35), jalgaon";
		String branchIFSC = "PPK9856";
